package app_photo.web.rest;

import app_photo.AppPhoto6App;
import app_photo.config.Constants;
import app_photo.domain.User;
import app_photo.repository.AuthorityRepository;
import app_photo.repository.UserRepository;
import app_photo.security.AuthoritiesConstants;
import app_photo.service.UserService;
import app_photo.service.dto.PasswordChangeDTO;
import app_photo.service.dto.UserDTO;
import app_photo.web.rest.vm.KeyAndPasswordVM;
import app_photo.web.rest.vm.ManagedUserVM;
...
import static app_photo.web.rest.AccountResourceIT.TEST_USER_LOGIN;
...
@SpringBootTest(classes = AppPhoto6App.class)
